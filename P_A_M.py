...
def main():
    print("Welcome to your personal assistant, one week trial. We have many options so just tell us your preferred characteristics.")
...
##Creating Assistant
    ...
    for day in range(1,8):
        ...
        if age_type == "child":
            if rediculous >= 50:
                print(your_assistant.name + " has soiled thier bed this morning and can no longer be there today.")
        ...
        while want_sched == "Y":
            ...
            while want_sched != "Y" and want_sched != "N":
                ...
                want_sched = input(your_assistant.name +": 'Would you like to schedule something for the week?' (Y/N): ").upper()
        #End of Scheduling
    print(your_assistant.name +": 'I hope have been a great experience!'")        
